...
class _VehicleRenewalDeliveryScreenState
  ...
  void _onNextPressed(BuildContext context) {
    ...
    final int method =
        selectedMethod == VehicleDeliveryMethod.delivery ? 2 : 1;
  ...
  void _navigateToOrderReview(
      BuildContext context, VehicleRenewalSuccess state) {
          ...
          return BlocConsumer<VehicleRenewalCubit, VehicleRenewalState>(
            listener: (context, state) {
              if (state is VehicleRenewalSuccess) {
                _navigateToOrderReview(context, state);
