...
class PaymentIntent {
  ...
  /// This is required to initialize the payment creation flow for service requests.
  final String? serviceRequestNumber;

  /// The IDs of the violations being paid for.
  /// This is required to initialize the payment creation flow for violations.
  final List<int>? violationIds;
